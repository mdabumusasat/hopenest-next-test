            ...
            <div className="row">
                    ...
                    <tbody>
                      ...
                      <tr className="cart_item">
                        ...
                        <form className="row g-3 coupon-form">
                          ...
                          <div className="col-auto">
                          <button type="submit" className="apply-button" name="apply_coupon" value="Apply Coupon"><span className="btn-title">Apply Coupon</span></button>
                          </div>
                        </form>
                        </td>
                        <td colSpan={2}>&nbsp;</td>
                        <td><button type="button" className="theme-btn btn-style-two"><span className="btn-title">Update Cart</span></button></td>
                    </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="col-md-12 mt-30">
                ...
                <div className="col-md-5">
                  ...
                  <div className="mb-30">
                    <button type="button" className="theme-btn btn-style-two"><span className="btn-title">Update Totals</span></button>
                  </div>
                  </form>
                </div>
                ...
                <div className="col-md-5">
                  ...
                  <Link className="theme-btn btn-style-two" href="/shop-checkout"><span className="btn-title">Proceed to Checkout</span> </Link> </div>
                </div>
              </div>
            </div>
          </div>
