...
function TeamDetails() {
	...
	useEffect(() => {
		...
		progressRefs.current.forEach((el: HTMLDivElement | null) => {
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8">
                        <form id="contact_form" name="contact_form" action="#" method="post">
                            ...
                            <div className="btn-box d-block mb-3 text-center">
                                <input name="form_botcheck" className="form-control" type="hidden" />
                                <button className="theme-btn btn-style-two mb-2 mb-sm-0" type="submit" data-loading-text="Please wait...">
                                    <span className="btn-title"> Send a Message</span>
                                </button>
                                <button type="reset" className="theme-btn btn-style-two ml-10">
